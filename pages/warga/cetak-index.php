...
class PDF extends FPDF
{
    ...
    {
      // Logo
      $this->Image('../../assets/img/logo-bogor.jpg',20,10);
    	...
    	// $this->Cell(60);
    	// Title
        $this->Cell(308,8,'PENGURUS RT. 003 RW 015',0,1,'C');
        $this->Cell(308,8,'KEL. CIANGSANA, KEC. GUNUNG PUTRI',0,1,'C');
    	$this->Cell(308,8,'BOGOR',0,1,'C');
    	// Line break
    	$this->Ln(5);
